<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdatePass.aspx.cs" Inherits="Education2.UpdatePass" %>
...
<body style=" background-image: url('WebImg/bodyback.jpg')">
  ...
  <td align="center" class="auto-style33"  >
      <table cellpadding="0" style="border-bottom: 1px solid #C0C0C0; height: 40px; width: 506px;" >
          <tr>
              <td class="auto-style34" style="text-align: left"><strong style="text-align: left;"><span class="auto-style35">密碼修改</span> </strong></td>
          </tr>
      </table>
      <br />
  ...
  <td align="left" class="auto-style42" rowspan="7">
  ...
  <td class="auto-style47">
                                            舊密碼</td>
  <td class="auto-style49">
      <asp:TextBox ID="txtold" CssClass="textbox" runat="server" Width="245px" Height="18px"></asp:TextBox>
  </td>
  </tr>
  ...
  <td class="auto-style47">
                                            新密 碼</td>
  <td class="auto-style49">
      <asp:TextBox ID="txtpass" CssClass="textbox" runat="server" Width="245px" Height="18px"></asp:TextBox>
  </td>
  </tr>
  ...
  <td class="auto-style47">
                                            確認密碼</td>
  <td class="auto-style49">
      <asp:TextBox ID="txtpass2" CssClass="textbox" runat="server" Width="245px" Height="18px"></asp:TextBox>
  </td>
  </tr>
  ...
  <td class="auto-style46" >
      <input type="button" value="修改密碼" runat="server"  onserverclick="submit1_Click"  class ="buttons"/>
